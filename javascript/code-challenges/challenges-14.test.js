...
const toTitleCase = (arr) => {
  ...
  arr.map(value=>{
    let regex=/\b\w/
    // console.log(value.match(regex)[0].toUpperCase());
    // value.match(regex).toUpperCase()
    let titleCase=value.replace(value.match(regex)[0],value.match(regex)[0].toUpperCase())
...
let biggerThanLuke = (arr) => {
  ...
  let array=[];
  arr.map(value=>{
    // console.log(Number(value.mass),array[0].mass,'Number(value.mass)>array[0].mass',Number(value.mass)>array[0].mass);
    if( Number(value.mass)>Number(arr[0].mass)){
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
if (checkwin(board,1,1,1,2,1,3)){return true;}
if (checkwin(board,2,1,2,2,2,3)){return true;}
if (checkwin(board,3,1,3,2,3,3)){return true;}
if (checkwin(board,1,1,2,1,3,1)){ 
  console.log('inside the correct condistion');
  return true;}
if (checkwin(board,1,2,2,2,3,2)){return true;}
if (checkwin(board,1,3,2,3,3,3)){return true;}
if (checkwin(board,1,1,2,2,3,3)){return true;}
if (checkwin(board,3,3,2,2,1,1)){return true;}
else{return false};
...
function checkwin (board,r1,c1,r2,c2,r3,c3){
  // console.log(board[r1-1][c1-1],board[r2-1][c2-1],board[r3-1][c3-1],board[r1-1][c1-1]===board[r2-1][c2-1]===board[r3-1][c3-1]==='X',board[r1-1][c1-1]===board[r2-1][c2-1]===board[r3-1][c3-1]==='O');
  if ((board[r1-1][c1-1]===board[r2-1][c2-1]        &&     board[r1-1][c1-1]===board[r3-1][c3-1]       && board[r3-1][c3-1]  ==='X')
  
  
  
  ||(board[r1-1][c1-1]==board[r2-1][c2-1]&& board[r1-1][c1-1]==board[r3-1][c3-1]&&board[r1-1][c1-1] =='O')){
    return true;}
  else{return false;}
}
/* ------------------------------------------------------------------------------------------------
