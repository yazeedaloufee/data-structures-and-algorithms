...
// const typeNum = (arr) => {
//   // Solution code here...
//   let array=arr.filter((value,idx)=>{
...
//   let array=[];
//   array=arr.filter((value,idx)=>{
//     // console.log(value.includes('and'));
...
const oddValues = (arr)=>{
  let array=arr.filter(value=>value%2);
  return array;
}
...
const notInFirstArray=(arr1,arr2)=>{
  let array=arr2.filter(value=>{
...
const getStatName = (arr, minBaseStat) => {
  ...
  let array2= array.map(value=>value.stat.name)
  return array2;
};
