...
const maxInArray = (arr) => {
  // Solution code here...
  let array = arr.reduce((acc, value, idx) => {
    if (value > acc) {
      acc = value;
    }
...
const checkValues = (obj, value) => {
 ...
 if(Object.values(obj)==value){
  ...
  // if (Object.values(obj).find(value)){return true}
  // else {return false;}
};
...
const updateNumbers = (obj) => {
  ...
  let arrayOutput=[];
  array.map(value=>{
    arrayOutput.push(`${value[0]}: ${value[1]}`)
...
const hasChildrenValues = (arr, character) => {
  ...
  let functionOutput=false;
  arr.forEach(value=>{
    if(value.name===character){
      if(value.children!==undefined){functionOutput = true;}
    }
    ...
    // console.log("these are the values",Object.values(value));
//     console.log('these are th echildrend',value.children);    
//     console.log(value.children,'is it equale to ',value.children!==undefined, 'function output before is ',functionOutput);
// if(value.children!==undefined){functionOutput = true;}

// console.log(value.children,'is it equale to ',  value.children!==undefined, 'function output after is ',functionOutput);

    // Object.values(value).forEach((value1)=>{

    //   if(value1==character){functionOutput =true;}
    //   else{functionOutput =false;}
     
    //   console.log('funtionoutput',functionOutput);
    // })
